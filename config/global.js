module.exports = {
  ...
  name: 'Lucyna Bugara',
  subtitle: 'UX / UI & Web designer',
  description: 'I started my career in IT as Project Manager. In time I realised that the most exciting part of the project for me is creative planning of <strong>UX/UI</strong> and <strong>Web Design</strong>. I\'ve always had multiple visions and ideas instantly while looking at the brief and tried to focus on what is going on in users head, how I can help him. I decided that my imagination is way to big to not start challenge it into the design :) ',
  socials: [
    ...
    {icon: 'fa-linkedin', name: 'linkedin', address: 'https://www.linkedin.com/in/lbugara/'},
  ],
  meta: {
