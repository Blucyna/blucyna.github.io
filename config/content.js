module.exports = [
  {
    ...
    mobileFlow: {
      images: ['img/shop/App-gif.gif'],
      title: 'Mobile application flow',
      placeholder: 'img/shop/App-gif.gif',
    },
    desktopFlow: {
      images: ['img/shop/desktop-gif.gif'],
      title: 'Mobile application flow',
      placeholder: 'img/shop/desktop-gif.gif',
    },
    mobileShowcase: {
  ...
  },
  {
    ...
    mobileFlow: {
      images: ['img/hbo/App_gif.gif'],
      title: 'Mobile application flow',
      placeholder: 'img/hbo/App_gif.gif',
    },
    desktopFlow: {
      images: ['img/hbo/desktop_gif.gif'],
      title: 'Mobile application flow',
      placeholder: 'img/hbo/desktop_gif.gif',
    },
    mobileShowcase: {
