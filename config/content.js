module.exports = [
  {
    ...
    mobileShowcase: 'img/shop/iPhone-showcase.jpg',
  ...
  },
  {
    ...
    goal: 'Creating user-friendly website that would be rich in details however simple overall.',
    mobileFlow: 'img/hbo/App_gif.gif',
    desktopFlow: 'img/hbo/desktop_gif.gif',
    mobileShowcase: 'img/hbo/mindmap.png',
    ...
    learnedThings: [
      'It is very easy to think we can simplify the process, however keeping it functional and simple at the same time is not easy,',
      'In case of multimarket platform as HBO GO I need to remember it will be translated for many languages, that is why copy and CTA placement must be chosen wisely.',
    ],
    mobileMockupsPreview: {
      label: 'Mobile mockups',
      id: 'preview-mockup-mobile',
    ...
    images: [
      'img/hbo/mockups/Home_Page_1336.png',
      'img/hbo/mockups/Movies_Category.png',
      'img/hbo/mockups/Movies_Category_2.png',
      'img/hbo/mockups/Movies_Category_3.png',
      'img/hbo/mockups/Movies_Popup.png',
      'img/hbo/mockups/Movie_window_Desktop.png',
      'img/hbo/mockups/Login.png',
      'img/hbo/mockups/Signup.png',
    ],
    mobileImages: [
      'img/hbo/mobile/Home_Page1.png',
      'img/hbo/mobile/Home_Page2.png',
      'img/hbo/mobile/Home_Page3.png',
      'img/hbo/mobile/Home_Page4.png',
    ],
    livePreviews: [
      //{label: 'Desktop prototype preview', id: 'preview-prototype', url: 'https://xd.adobe.com/view/1fe51c59-ebbb-4d4d-7eb6-d97b82dbf884-69d4'},
    ]
